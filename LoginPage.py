...
def save_data_to_csv(entry_field):
    # 1. Get the string from the Entry widget
    user_input = entry_field.get()
    
    skip = ""  # Placeholder for the first column if needed
...
save_button = tk.Button(window, text="Save to CSV", command=save_data_to_csv(entry_field1))
