class ItemInfo:
    ...
    '''
    def __init__(self, itemID, userID, itemName, itemDescription, itemCondition, itemCategory, itemPrice, itemStatus, itemComments, itemImage, itemBuyers):
